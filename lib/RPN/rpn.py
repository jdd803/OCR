...
class rpn:
    ...
    def _network(self):
        ...
        with tf.variable_scope('rpn'):
            ...
            # features = slim.conv2d(rpn_layers,256,(3,3))
            features = Conv2D(256,(3,3),padding='same')(rpn_layers)
            ...
            with tf.variable_scope('cls'):
                ...
                self.rpn_bbox_cls_layers = Conv2D(_num_anchors * 2, (1, 1))(features)
            ...
            with tf.variable_scope('bbox'):
                ...
                self.rpn_bbox_pred_layers = Conv2D(_num_anchors * 4, (1, 1))(features)
