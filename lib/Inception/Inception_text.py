...
def inception_text_layer(inputs, conv11_size=256,conv11_11_size=256, conv33_11_size=256, conv33_22_size=256,
    ...
    with tf.variable_scope("conv_1x1"):
        ...
        conv11_redu = Conv2D(conv11_size, 1)(inputs)
        conv11_11 = Conv2D(conv11_11_size, 1)(conv11_redu)
        conv11_11_offset = ConvOffset2D(256, name='conv11_offset')(conv11_11)
        conv11_out = Conv2D(conv11_11_size, 3, padding='same', activation=lrelu)(conv11_11_offset)
    with tf.variable_scope("conv_3x3"):
        ...
        conv33_redu = Conv2D(conv11_size, 1)(inputs)
        conv33_11 = Conv2D(conv33_11_size, (1,3), padding='same')(conv33_redu)
        conv33_22 = Conv2D(conv33_22_size, (3,1), padding='same')(conv33_11)
        conv33_offset = ConvOffset2D(256, name='conv33_offset')(conv33_22)
        conv33_out = Conv2D(conv33_22_size, 3, padding='same', activation=lrelu)(conv33_offset)
    with tf.variable_scope("conv5x5"):
        ...
        conv55_redu = Conv2D(conv11_size, 1)(inputs)
        conv55_11 = Conv2D(conv55_11_size, (1,5), padding='same')(conv55_redu)
        conv55_22 = Conv2D(conv55_22_size, (5,1), padding='same')(conv55_11)
        conv55_offset = ConvOffset2D(256, name="conv55_offser")(conv55_22)
        conv55_out = Conv2D(conv55_22_size, 3, padding='same', activation=lrelu)(conv55_offset)
    # conv_shortcut = slim.conv2d(inputs,conv_shortcut_size,(1,1))
    conv_shortcut = Conv2D(conv_shortcut_size,1)(inputs)
    ...
    conv_concat_conv = Conv2D(256,1)(conv_concat)  # (batch,16,16,256)
