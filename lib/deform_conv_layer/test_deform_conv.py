...
from lib.deform_conv_layer.deform_conv import (
    tf_map_coordinates,
...
def test_tf_batch_map_coordinates():
    ...
    coords = np.random.random((4, 10000, 2)) * 99
...
def main():
    test_tf_map_coordinates()
    test_tf_batch_map_coordinates()
    test_tf_batch_map_offsets()
    test_tf_batch_map_offsets_grad()
