...
train_img_path = './dataset/ch4_training_images/'
train_gtbox_path = './dataset/ch4_training_localization_transcription_gt/'
train_mask_path = './dataset/ch4_training_localization_transcription_mask/'
